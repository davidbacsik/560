...
To generatize the likelihood function, there will a term with \[e^{-\theta}\] raised to the n (the number of observations in the dataset):  
\[(e^{-\theta})^{n}\]

There will also be a term with \theta raised to the sum of all mutations (i) observed:  
\[\theta^{\sum_{i=1}^{n} i}\]

Finally, there will be a term of \[\frac{1}{i1! \cdot i2! \cdot i3! ... in! }\].